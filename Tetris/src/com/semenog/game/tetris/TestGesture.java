...
public void	train() {
    ...
    OpdfMultiGaussianFactory initFactoryPunch = new OpdfMultiGaussianFactory(3);
    
    Log.i("if", "looping");
    //Reader learnReaderPunch = new FileReader(new File (myDir, "PonnamUP.seq"));
    Reader learnReaderPunch = new FileReader(new File (myDir, "fly.seq"));
    ...
    //Reader learnReaderScrolldown = new FileReader(new File (myDir, "PonnamRight.seq"));
    Reader learnReaderScrolldown = new FileReader(new File (myDir, "right.seq"));
    ...
    //Reader learnReaderSend = new FileReader(new File (myDir, "PonnamLeft.seq"));
    Reader learnReaderSend = new FileReader(new File (myDir, "left.seq"));
    ...
    BaumWelchLearner baumWelchLearnerSend = new BaumWelchLearner();
     ...
     Log.i("Train message", "Training Success");
	  }
	  catch(Exception e){
		  x2--;
		  //System.out.println(x2);
